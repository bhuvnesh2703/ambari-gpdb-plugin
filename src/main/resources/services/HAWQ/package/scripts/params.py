...
hawq_bashrc = "{0}/.bashrc"
hawq_profile    = "{0}/.hawq-profile.sh"
source_command_tmpl = "echo 'source " + hawq_profile + "' >> " + hawq_bashrc
already_appended_command_tmpl = "cat " + hawq_bashrc + " | grep 'source " + hawq_profile + "'"
